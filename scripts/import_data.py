...
def dedupe_words(words: list[dict]) -> tuple[list[dict], int]:
    """Drop duplicates on (spanish_word, stage). Keep first occurrence."""
...
def main() -> int:
    ...
    all_words, dropped_words = dedupe_words(all_words)
